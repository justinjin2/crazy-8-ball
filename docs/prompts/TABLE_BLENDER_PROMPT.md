...
- **Use `assets/table/TableModel.py` and `table_common.py` as the template** (the rake's
  `Bridge.py`, the original template, was removed 2026-09-25): a commented `PARAMETERS` dict,
