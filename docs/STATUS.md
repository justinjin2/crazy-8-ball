...
- **E:** mouse/touch spin selector with full-disc dragging, Center and Done. The 80 px ball
  ...
  0.5R physics limit, with the dot kept inside its edge. The selector marker is 36 px,
  slightly smaller than the earlier 39.6 px version; the left toggle stays at 17.6 px. Gamepad:
